...
namespace Kinematics
{
  namespace basic
  {
    ...
    inline void f_unilateral_RightTL3DMultiWalking(Eigen::MatrixXd &p_output1, const Eigen::VectorXd &var)
    {
      // Check
      // - Inputs
      ...
      f_unilateral_RightTL3DMultiWalking_raw(p_output1.data(), var.data());
    }
...
#endif // F_UNILATERAL_RIGHTTL3DMULTIWALKING_HH
