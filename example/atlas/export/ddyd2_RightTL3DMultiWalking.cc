 ...
 * Wed 29 Mar 2017 17:29:10 GMT-04:00
 */
...
static void output1(double *p_output1,const double *t,const double *a)
{
  ...
  p_output1[7]=-60.*t3*t44 + 30.*t3*t45 + 120.*t10*t2*t46 + 30.*t12*t47 - 240.*t10*t2*t47 - 60.*t12*t48 + 120.*t10*t2*t48 + 180.*t45*t7*t8 - 360.*t46*t7*t8 + 180.*t47*t7*t8 + 30.*t3*a[49] + 30.*t12*a[55] + 120.*t44*t5*t[0] - 240.*t45*t5*t[0] + 120.*t46*t5*t[0];
  p_output1[8]=-60.*t3*t49 + 30.*t3*t50 + 120.*t10*t2*t51 + 30.*t12*t52 - 240.*t10*t2*t52 - 60.*t12*t53 + 120.*t10*t2*t53 + 180.*t50*t7*t8 - 360.*t51*t7*t8 + 180.*t52*t7*t8 + 30.*t3*a[56] + 30.*t12*a[62] + 120.*t49*t5*t[0] - 240.*t5*t50*t[0] + 120.*t5*t51*t[0];
  p_output1[9]=-60.*t3*t54 + 30.*t3*t55 + 120.*t10*t2*t56 + 30.*t12*t57 - 240.*t10*t2*t57 - 60.*t12*t58 + 120.*t10*t2*t58 + 180.*t55*t7*t8 - 360.*t56*t7*t8 + 180.*t57*t7*t8 + 30.*t3*a[63] + 30.*t12*a[69] + 120.*t5*t54*t[0] - 240.*t5*t55*t[0] + 120.*t5*t56*t[0];
  p_output1[10]=-60.*t3*t59 + 30.*t3*t60 + 120.*t10*t2*t61 + 30.*t12*t62 - 240.*t10*t2*t62 - 60.*t12*t63 + 120.*t10*t2*t63 + 180.*t60*t7*t8 - 360.*t61*t7*t8 + 180.*t62*t7*t8 + 30.*t3*a[70] + 30.*t12*a[76] + 120.*t5*t59*t[0] - 240.*t5*t60*t[0] + 120.*t5*t61*t[0];
}
...
#include "ddyd2_RightTL3DMultiWalking.hh"
...
void ddyd2_RightTL3DMultiWalking_raw(double *p_output1, const double *t,const double *a)
{
  // Call Subroutines
  output1(p_output1, t, a);
