...
static void output1(double *p_output1,const double *t,const double *a)
{
  ...
  p_output1[7]=6.*t3*t46 - 60.*t10*t11*t48 + 60.*t10*t11*t49 - 30.*t13*t2*t49 - 6.*t15*t50 + 30.*t13*t2*t50 - 60.*t47*t7*t8 + 60.*t48*t7*t8 - 6.*t3*a[49] + 6.*t15*a[55] - 30.*t46*t5*t[0] + 30.*t47*t5*t[0];
  p_output1[8]=6.*t3*t51 - 60.*t10*t11*t53 + 60.*t10*t11*t54 - 30.*t13*t2*t54 - 6.*t15*t55 + 30.*t13*t2*t55 - 60.*t52*t7*t8 + 60.*t53*t7*t8 - 6.*t3*a[56] + 6.*t15*a[62] - 30.*t5*t51*t[0] + 30.*t5*t52*t[0];
  p_output1[9]=6.*t3*t56 - 60.*t10*t11*t58 + 60.*t10*t11*t59 - 30.*t13*t2*t59 - 6.*t15*t60 + 30.*t13*t2*t60 - 60.*t57*t7*t8 + 60.*t58*t7*t8 - 6.*t3*a[63] + 6.*t15*a[69] - 30.*t5*t56*t[0] + 30.*t5*t57*t[0];
  p_output1[10]=6.*t3*t61 - 60.*t10*t11*t63 + 60.*t10*t11*t64 - 30.*t13*t2*t64 - 6.*t15*t65 + 30.*t13*t2*t65 - 60.*t62*t7*t8 + 60.*t63*t7*t8 - 6.*t3*a[70] + 6.*t15*a[76] - 30.*t5*t61*t[0] + 30.*t5*t62*t[0];
}
...
#include "dyd2_RightTL3DMultiWalking.hh"
...
void dyd2_RightTL3DMultiWalking_raw(double *p_output1, const double *t,const double *a)
{
  // Call Subroutines
  output1(p_output1, t, a);
