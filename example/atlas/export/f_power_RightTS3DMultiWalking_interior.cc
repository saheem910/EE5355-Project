...
static void output1(double *p_output1,const double *var,const double *auxdata)
{
  double _NotUsed;
  NULL;
  p_output1[0]=(2*var[0]*Sqrt(Power(var[15],2)*Power(var[22],2) + Power(var[16],2)*Power(var[23],2) + Power(var[17],2)*Power(var[24],2) + Power(var[21],2)*Power(var[25],2) + Power(var[18],2)*Power(var[26],2) + Power(var[19],2)*Power(var[27],2) + Power(var[20],2)*Power(var[28],2)))/(3.*(-1 + auxdata[0]));
}
...
#include "f_power_RightTS3DMultiWalking_interior.hh"
